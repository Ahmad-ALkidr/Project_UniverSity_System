...
class colleges:
    def __init__(self, centerFrame):
        ...
        self.universityInfo.grid(row=0, column=0, sticky='nsew', pady=5)
        ...
        self.ButtonUniversity = Button(self.universityInfo, command=self.openInfowindo, text="College Management",
...
class InfoWindow:
    def __init__(self):
        ...
        self.master.title('(✿◡‿◡)Colleges Management System(✿◡‿◡)')
        ...
        self.NameCollegeE = Entry(self.frameleft, fg='#4F4F4F', font=('tahoma', 12, 'bold'),
                                  textvariable=self.NameCollege, bd=2)
        ...
        self.NumTeacherE = Entry(self.frameleft, fg='#4F4F4F', font=('tahoma', 12, 'bold'),
                                 textvariable=self.NumTeacher, bd=2)
