...
class maneger:
    def __init__(self):
        ...
        self.Enter = Button(self.frameEnter, command=self.login1, width=25, text="Login", pady=10, bg='#1b9ea4',
                            ...
                            cursor='mouse')
        self.Enter.grid(row=3, column=0, columnspan=2, sticky='nsew', pady=80)
...
class Add_User:
    def __init__(self, window):
        ...
        self.Enter = Button(self.frameEnter, command=self.Log, width=25, text="Add user", pady=10, bg='#1b9ea4',
                            activeforeground='white', activebackground='#750E21', font=('tahoma', 10, 'bold'), bd=15)
