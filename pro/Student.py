...
class Student:
    def __init__(self, centerFrame):
        ...
        self.ButtonStudent = Button(self.studentFrame, command=self.openstudentwindo, text="Student Management",
                                    bg='#1b9ea4', fg='white', padx=10, pady=10, font=("tahoma", 10, 'bold'))
...
class StudentWindow:
    def __init__(self):
        ...
        # -------------------------------------------------------#
        self.FirstName = Label(self.frameleft, text='FirstName', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        self.FirstName.place(x=10, y=202)
        self.LastName = Label(self.frameleft, text='LastName', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        self.LastName.place(x=10, y=262)
        self.CIN = Label(self.frameleft, text='CIN', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        self.CIN.place(x=10, y=322)
        self.Email = Label(self.frameleft, text='Email', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        self.Email.place(x=10, y=382)
        self.Phone = Label(self.frameleft, text='Phone', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        self.Phone.place(x=10, y=442)
        self.Date = Label(self.frameleft, text='Date', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        ...
        self.id_TecherL = Label(self.frameleft, text='id_Techer', font=('tahoma', 10, 'bold'), width=12, bg='#D35400')
        ...
        "ID", "FirstName", "LastName", "CIN", "Email", "Phone", "Date", "id_colleges", "id_Teacher", "Gender", 'photo'),
        ...
        self.ptp = Button(self.frameleft, text="أضافة صورة", command=self.open_files1, bg='#D35400',
                          activeforeground='white', activebackground='#750E21', font=('tahoma', 10, 'bold'),
                          cursor='plus')
        self.ptp.place(x=250, y=80, height=50, width=80)
        self.lab = Label(self.frameleft , height=150, width=150, image=self.new_im00)
                                ...
                                if self.is_valid_date(self.DateEntry.get()):
                                    if self.var.get() != 0:
                                        if self.lab['image']:
                                            ...
                                            mb.showerror('error', 'لم يتم اضافة صورة')
                                    else:
                                    ...
                                    if self.var != 0:
                                        if self.lab["image"]:
                                            ...
                                            if self.is_valid_date(self.DateEntry.get()):
                                                ...
                                                mb.showerror('Error','لم تقم بتحديد صورة')
